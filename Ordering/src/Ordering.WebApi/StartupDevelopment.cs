        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            // Entity Context - Do Not Delete
                ...
                using (var context = app.ApplicationServices.GetService<OrderingDbContext>())
                {
                    ...
                    OrderSeeder.SeedSampleOrderData(app.ApplicationServices.GetService<OrderingDbContext>());
                    PropertySeeder.SeedSamplePropertyData(app.ApplicationServices.GetService<OrderingDbContext>());
                    AgentSeeder.SeedSampleAgentData(app.ApplicationServices.GetService<OrderingDbContext>());                    OfficeSeeder.SeedSampleOfficeData(app.ApplicationServices.GetService<OrderingDbContext>());
                }
