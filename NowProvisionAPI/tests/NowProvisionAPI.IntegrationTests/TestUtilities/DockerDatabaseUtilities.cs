...
namespace NowProvisionAPI.IntegrationTests.TestUtilities
{
    using Docker.DotNet;
    ...
    public static class DockerSqlDatabaseUtilities
    {
        ...
        public const string DB_CONTAINER_NAME = "IntegrationTestingContainer_NowProvisionAPI";
        public const string DB_VOLUME_NAME = "IntegrationTestingVolume_NowProvisionAPI";
                ...
                var sqlContainer = await dockerClient
                    ...
                    .CreateContainerAsync(new CreateContainerParameters
                    {
                        ...
                        HostConfig = new HostConfig
                        {
                            ...
                            {
                                $"{DB_VOLUME_NAME}:/NowProvisionAPI_data"
                            }
                        },
                    });
